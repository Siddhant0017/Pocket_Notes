...
import homeImg from "../assests/home-img.png";
...
const Home = ({ noteBtnClick, isMobile }) => {
  ...
  return (
    <div className={`main-welcome ${noteGroups && isMobile && noteGroups.length > 0 ? "hide-main" : "show-main"}`}>
      <img src={homeImg} alt="img" width="400px" className="main-welcome-img" />
      <h2 className="main-welcome-title">Pocket Notes</h2>
      <p className="main-welcome-desc">
        Send and receive messages without keeping your phone online. Use Pocket
        Notes on up to 4 linked devices and 1 mobile phone
      </p>
      <p className="main-welcome-bottom flex flex-row">
        <svg
